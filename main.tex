...
%%%%%%%%%%%%%%%INTRODUCIÓN%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Introducción} %%251 palabras + 2
...
\subsection{Ejecución serial y paralela} %% 127 +5
...
\subsubsection{Notación \textit{Big-O}}%264 +3
...
\subsection{Merge Sort Recursivo Serial (MSRS)} %%291 +6
...
\subsubsection{Complejidad temporal}%%98 +3
...
\newpage
%%753
\subsection{Merge Sort Recursivo Paralelo (MSRP)}%%731 +6
